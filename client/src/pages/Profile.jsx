    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <img
          ...
          className="rounded-full h-24w-24 
        ...
        text-center hover: opacity-90 p-3 rounded-lg uppercase"
          to={"/create-listing"}
        >
          Create Listing
        </Link>
      ...
      {userListings.length > 0 && (
        <div className="flex flex-col gap-4">
          ...
          justify-between items-center gap-4 flex"
          >
            ...
            <Link
              className="text-slate-700 flex-1 font-semibold 
            ...
            <div className="flex gap-2 flex-col items-center">
              <button
               onClick={()=>handleListingDelete(listing._id)} className="text-red-700 
              border rounded-lg 
